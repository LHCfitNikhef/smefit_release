...
def build_uv_posterior(results):
	results["gWH"] = ((0-2J)*np.emath.sqrt(results.O3pl1)*np.emath.sqrt(results.O3pl2))/np.emath.sqrt(results.Oll)
	...
	results["gWqf11"] = ((0+2J)*np.emath.sqrt(results.Oll)*results.OpqMi)/(np.emath.sqrt(results.O3pl1)*np.emath.sqrt(results.O3pl2))
