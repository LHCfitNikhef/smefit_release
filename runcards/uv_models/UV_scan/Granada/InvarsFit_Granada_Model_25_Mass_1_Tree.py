...
def build_uv_posterior(results):
	results["gGdf11"] = ((0-1J)*np.emath.sqrt(6)*results.O8qd*np.emath.sqrt(results.Ott1))/results.OQt8
	results["gGqf33"] = ((0-1J)*results.OQt8)/(np.emath.sqrt(6)*np.emath.sqrt(results.Ott1))
