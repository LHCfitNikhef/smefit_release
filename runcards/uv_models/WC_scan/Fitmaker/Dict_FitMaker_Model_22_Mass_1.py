...
invar1 = (np.emath.sqrt(2.8504283398934938)*np.abs(np.emath.sqrt(ctp)*m))/2**0.25
# ~~~~~~~~~~~~~~~~~~~~~~
# One possible solution of the equation relating the UV couplings to the WCs.
gB1H = ((0-1J)*np.emath.sqrt(2.8504283398934938)*np.emath.sqrt(ctp)*m)/2**0.25
