...
inv_param_dict = {2: {'inv1': r"$\left|\kappa_{\mathcal{S}}\right|$"},
                  ...
                  21: {'inv1': r"$\left|\left(g_B^d\right)_{11}\right|$",
                       'inv2': r"$\left|\left(g_B^e\right)_{11}\right|$",
                       'inv3': r"$\left|\left(g_B^e\right)_{22}\right|$",
                       'inv4': r"$\left|\left(g_B^e\right)_{33}\right|$",
                       'inv5': r"$\mathrm{sgn}(\left(g_B^d\right)_{11})g_B^\phi$",
                       'inv6': r"$\mathrm{sgn}(g_B^\phi) \left(g_B^q\right)_{11}$",
                       'inv7': r"$\mathrm{sgn}(g_B^\phi) \left(g_B^q\right)_{33}$",
                       'inv8': r"$\mathrm{sgn}(g_B^\phi) \left(g_B^u\right)_{11}$",
