...
(*Print the card*)
massReemp={Symbol[SymbolName[m]]->1/Symbol[SymbolName[invmass]]};
...
WriteLine[str1,printNameWCs[dicTotal[[ind1,1]]]<>" : "<>"["<>StringRiffle[funcRemoveZeros[Flatten[MapIndexed[writeStrBlock[varsUV],CoefficientList[N[dicTotal[[ind1,2]]/.massReemp],varsUV/.{Symbol[SymbolName[m]]->Symbol[SymbolName[invmass]]}],{Length[varsUV]}]]],","]<>"]"]];
WriteLine[str1,"# ~~~~~~~~~~~~~~~~~~~~~~"];
